...
- Log in to osTicket using the credentials you made during the installation tutorial </h3>
	- If you need help installing osTicket, please see my tutorial [here](https://github.com/eddielaformjr/osticket-prereqs)
...
🎉Congratulations! You have configured osTicket succesfully!🎉 Click [here](https://github.com/eddielaformjr/ticket-lifecycle) to move on to the final part of this tutorial! 
